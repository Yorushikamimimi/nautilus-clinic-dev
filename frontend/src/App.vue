<template>
  <div>
    <nav v-if="isLoggedIn" style="padding:12px 24px;background:#1a73e8;display:flex;gap:16px;align-items:center">
      <span style="color:#fff;font-weight:bold;margin-right:auto">门诊管理系统</span>
